...
public class MobileConstruction : PartModule
{
    ...
    {
        base.OnAwake();
        if (debug) Debug.Log("[MobConst] OnAwake fired");
    }
    ...
    public override void OnLoad(ConfigNode node)
    {
        ...
        if (debug) Debug.Log("[MobConst] OnLoad fired");
    ...
    public override void OnSave(ConfigNode node)
    {
        ...
        if (HighLogic.LoadedSceneIsFlight)
        {
            if (debug) Debug.Log("[MobConst] OnSave fired");
    ...
    public void Start()
    {
        if (debug) Debug.Log("[MobConst] Start fired");
    ...
    {
        Debug.Log("[MobConst]: The Window said: " + s);
    }
...
class MyWindow : Window<MyWindow>
{
    ...
    public override void Load(ConfigNode node)
    {
        ...
        var configFilename = IOUtils.GetFilePathFor(this.GetType(), "MobileConstruction.cfg");
